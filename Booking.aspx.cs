    ...
    public partial class Booking : Page
    {
        ...
        protected void btnConfirmBooking_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    string sql = @"INSERT INTO Bookings (BookingRef, ClientEmail, FreelancerEmail, ServiceTitle, ProjectTitle, Description, BookingDate, Package, TotalAmount, PaymentMethod, Status, CreatedAt)
