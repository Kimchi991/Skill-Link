            ...
            <div class="glass-card">
                ...
                <asp:Panel ID="Panel1" runat="server" Visible="false">
                    ...
                    <div style="display:flex;justify-content:space-between;align-items:center;background:rgba(45,212,191,0.08);border:1px solid rgba(45,212,191,0.2);border-radius:10px;padding:12px 16px;margin-bottom:20px;">
                        ...
                        <span style="color:#2dd4bf;font-weight:bold;font-size:1rem;">₱<asp:Literal ID="Literal1" runat="server" /></span>
                    </div>
                    ...
                    <asp:Button ID="Button1" runat="server" Text="Confirm &amp; Place Order"
                        OnClick="btnConfirmBooking_Click" CssClass="btn-neon"
                        OnClientClick="return bookingSimulatePayment();" />

                    <asp:Button ID="Button2" runat="server" Text="Wait, Go Back"
                ...
                <script>
                    ...
                    function bookingSimulatePayment() {
                        ...
                        document.getElementById('bSpinAmount').textContent = '₱' + parseFloat('<%= hdnTotalAmount.Value %>'.replace(/[^\d.]/g, '') || 0).toLocaleString();
